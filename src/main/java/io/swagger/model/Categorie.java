...
public class Categorie {
	...
	@Transient
	private Iterable<Categorie> categoriefils;

	public Iterable<Categorie> getCategoriefils() {
		return categoriefils;
	}

	public void setCategoriefils(Iterable<Categorie> categoriefils) {
		this.categoriefils = categoriefils;
	}
